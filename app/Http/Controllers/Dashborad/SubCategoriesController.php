...
class SubCategoriesController extends Controller
{
    ...
    {
        Gate::authorize('sub_categories.store');
    ...
    {
        Gate::authorize('sub_sub_categories');
        $sub_category = Category::where('id',$id)->first();
        $main_category = Category::where('id',$sub_category->main_parent)->first();
        $categories = Category::where('main_parent',$main_category->id)
        ->where('sub_parent',$id)
        ->get();
    ...
    {
        Gate::authorize('sub_categories.edit');

        $main_categories = Category::where('type',0)->get();
        $category = Category::find($id);
        return view('dashborad.categories.edit_subCategories',[
            'category'=>$category,
