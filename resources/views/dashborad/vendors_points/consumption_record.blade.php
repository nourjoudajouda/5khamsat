...
@section('content')
        ...
        <div class="content-wrapper">
                        ...
                        <div class="card card-congratulation-medal">
                            <div class="card-body">
                                ...
                                <h3 class="mb-75 mt-2 pt-50">
                                    <a href="javascript:void(0);">{{ $points->points - $points->points_spent }}
                                        {{ __('common.point') }}</a>
                                </h3>
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#Recharge_points">{{ __('common.Recharge_points') }}</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">{{ $points_monthly->sum('points') }}
                                                </h4>
                                    ...
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">{{ $points_yearly->sum('points') }}
                                                </h4>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">
                                                    {{ date('d-m-Y', strtotime($points->date_shipping)) }}</h4>
                                                <p class="card-text font-small-3 mb-0">
                                                    {{ __('common.end_recharge_points') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody id="menu">
                                            @foreach ($products as $product)
                                                <tr id="tr-{{ $product->id }}">
                                                    ...
                                                    <td><span
                                                            class="badge badge-pill badge-light-primary mr-1">{{ $product->points }}</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="badge badge-pill badge-light-danger mr-50"
                                                            href="#myModal{{ $product->products->id }}" role="button"
                                                            data-toggle="modal">
                                                            {{ __('common.delete') }}
                                                        </div>
                                                        <a
                                                            href="{{ url(app()->getLocale() . '/orders/' . $product->order_id) }}">
                                                ...
                                                <!--Form Delete -->
                                                <div id="myModal{{ $product->products->id }}" class="modal fade"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-danger"
                                                                    onclick="delete_adv({{ $product->products->id }})">{{ __('common.delete') }}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            @else
                <div style="text-align: center;height: 400px;padding-top: 100px;">
                    <h4 class="text-center">{{ __('common.Dear vendor // To do the point recharge process, click here') }}
                    </h4>
                    <br>
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#Recharge_points">{{ __('common.Recharge_points') }}</button>
    ...
    <!--Recharge_points-->
    <div class="modal fade text-left" id="Recharge_points" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" style="max-width:50%;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ url(app()->getLocale() . '/points') }}" enctype="multipart/form-data"
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input id="t-text" type="number" name="points" placeholder="{{ __('common.points') }}"
                                class="form-control">
                        ...
                        <div style="display:none;" id="Recharge_points_section">
                            <div style="margin-bottom: 20px;">
                                ...
                                <input id="t-text" type="text" name="amount"
                                    placeholder="{{ __('common.amount') }}" class="form-control">
                            </div>
