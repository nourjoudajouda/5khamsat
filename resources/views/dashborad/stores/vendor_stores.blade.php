                        ...
                        <div class="form-group breadcrumb-right">
                            <div class="dropdown">
                                <button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle"
                                    data-toggle="modal" data-target="#store_vendor" type="button" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">{{ __('common.add_new_store') }}</button>
                            </div>
                        </div>
                    </div>
                @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card knowledge-base-bg text-center"
                                    style="background-image: url({{ asset('/dashborad/app-assets/images/banner/banner.png') }})">
                                    <div class="card-body">
                                    ...
                                    <div class="card knowledge-base-bg text-center"
                                        ...
                                        <div class="card-body">
                                            <h2 class="text-primary">
                                                {{ __('common.You have no free space in warehouses') }}</h2>
                                            <div class="input-group input-group-merge">
                                                <button class="btn btn-primary" data-toggle="modal"
                                                    data-target="#store_vendor" type="button" data-toggle="dropdown"
                                                    style="margin:auto">{{ __('common.Reserve an empty space') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                @foreach ($stores as $store)
                                                    <tr id="tr-{{ $store->id }}">
                                                        ...
                                                        <td style="text-align: center;"><span
                                                                class="badge badge-pill badge-light-success mr-1">{{ $store->area }}</span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td style="text-align: center;"><span
                                                                class="badge badge-pill badge-light-secondary mr-1">{{ $store->stores->created_at }}</span>
                                                        </td>

                                                        <td>
                                                            <a
                                                                href="{{ url(app()->getLocale() . '/vendor_store/' . $store->store_id) }}">
                        ...
                        <div class="modal-dialog" style="max-width:65%;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{ url(app()->getLocale() . '/store_stores_vendor') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-6 mx-auto">
                                                <div style="margin-bottom: 20px;">
                                                    <label for="t-text"
                                                        class="">{{ __('common.length') }}</label>
                                                    <input id="t-text" type="number" name="length"
                                                        placeholder="{{ __('common.length') }}" class="form-control"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-6 mx-auto">
                                                <div style="margin-bottom: 20px;">
                                                    <label for="t-text"
                                                        class="">{{ __('common.height') }}</label>
                                                    <input id="t-text" type="number" name="height"
                                                        placeholder="{{ __('common.height') }}" class="form-control"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-6 mx-auto">
                                                <div style="margin-bottom: 20px;">
                                                    ...
                                                    <input id="t-text" type="number" name="width"
                                                        placeholder="{{ __('common.width') }}" class="form-control"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
