                                ...
                                <table class="table">
                                    ...
                                    <tbody id="menu_new">
                                        ...
                                        <tr id="tr_new-{{$store->id}}">
                                            ...
                                            <td><span class="badge badge-pill badge-light-info mr-1">{{ $store->area }}</span></td>
                                            <td><span class="badge badge-pill badge-light-warning mr-1">{{ $store->area - $store->spent_space }}</span></td>
                                            <td><span class="badge badge-pill badge-light-danger mr-1">{{ $store->spent_space }}</span></td>
                                            <td><span class="badge badge-pill badge-light-success mr-1">{{ $store->created_at }}</span></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="order-tab" data-toggle="tab" href="#canceled_bookings" aria-controls="canceled_bookings" role="tab" aria-selected="false">{{__('common.canceled_shippments')}}</a>
                                        </li>
                                    </ul>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody id="menu_new">
                                                                    ...
                                                                    <tr id="tr_new-{{$order->id}}">
                                                                        ...
                                                                        <td><span class="badge badge-pill badge-light-info mr-1">{{ $order->total_volume }}</span></td>
                                                                ...
                                                                <tbody id="menu_new">
                                                                    ...
                                                                    <tr id="tr_new-{{$order->id}}">
                                                                        ...
                                                                        <td style="display: flex;padding-top:23px;">
                                                                            ...
                                                                            <a href="{{url(app()->getLocale().'/details_booking_orders/'.$order->id)}}">
