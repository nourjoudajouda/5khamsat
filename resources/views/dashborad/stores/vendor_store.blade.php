        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-6 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        <button class="btn badge badge-pill badge-light-success" type="button">{{__('common.date_booking')}} : {{$store->created_at}} </button>
                        <button class="btn badge badge-pill badge-light-danger" type="button">{{__('common.Remaining amount')}} : {{$invoices->sum('price')}}$ </button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="card card-congratulation-medal">
                        <div class="card-body">
                            ...
                            <button type="button" data-toggle="modal" data-target="#extra_space" class="btn btn-primary">{{__('common.extra_spaces')}}</button>
                            @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-xl-0">
                                    <div class="media">
                                        ...
                                        <div class="media-body my-auto">
                                            <h4 class="font-weight-bolder mb-0">{{$store->area - $store->spent_space}}</h4>
                            ...
                            <table class="table">
                                ...
                                <tbody id="menu">
                                    ...
                                    <tr id="tr-{{$product->id}}">
                                        ...
                                        <td><span class="badge badge-pill badge-light-success mr-1">{{ $product->product_qty }}</span></td>
                                        ...
                                        <td style="display: flex;padding-top:23px;">
                                            ...
                                            <a href="{{url(app()->getLocale().'/products/'.$product->products->id)}}">
                                                <div class="badge badge-pill badge-light-warning mr-50">
                                                    {{__('common.view')}}
                                                </div>
                                            </a>
                                            @can('products.edit')
                                            <a href="{{url(app()->getLocale().'/products/'.$product->products->id.'/edit')}}">
                                            ...
                                            <div id="return_from_store{{$product->products->id}}" class="badge badge-pill badge-light-info mr-50" style="cursor: pointer;" data-toggle="modal" data-target="#return_product{{$product->products->id}}">
                                                {{__('common.return')}}
                                            </div>
                                            @else
                                    ...
                                    <!--Return Store-->
                                    <div id="return_product{{$product->products->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                        <div class="modal-dialog">
                                            <!-- Modal content-->
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">{{__('common.return_from_store')}}</h5>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div style="text-align: center;">
                                                                    <img src="{{$product->products->image}}" width="100%" height="350" alt="" />
                                                                ...
                                                                <div style="margin-bottom: 20px;">
                                                                    ...
                                                                    <input id="t-text" type="number" name="return_qty" placeholder="{{__('common.Qty')}}" class="form-control" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer md-button">
                                                            <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i>{{__('common.cancel')}}</button>
                                                            <button id="btn_return_to_trader" class="btn btn-primary">{{__('common.save')}}</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" aria-controls="home" role="tab" aria-selected="true">{{__('common.new_shippments')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" aria-controls="profile" role="tab" aria-selected="false">{{__('common.acceptted_shippments')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#inprocess" aria-controls="inprocess" role="tab" aria-selected="false">{{__('common.inprocess_shippments')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="order-tab" data-toggle="tab" href="#order" aria-controls="order" role="tab" aria-selected="false">{{__('common.stored_shippments')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="canceled_bookings-tab" data-toggle="tab" href="#canceled_bookings" aria-controls="order" role="tab" aria-selected="false">{{__('common.canceled_shippments')}}</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home" aria-labelledby="profile-tab" role="tabpanel">
                                        <!-- Basic Tables start -->
                                        <div class="row" id="basic-table">
                                            <div class="col-12">
                                                <div class="card">
                                                            ...
                                                            <tbody id="menu">
                                                                ...
                                                                <tr id="tr_new-{{$order->id}}">
                                                                    ...
                                                                    <td style="display: flex;padding-top:23px;">
                                                                        ...
                                                                        @can('booking.orders.operations')
                                                                        <div class="badge badge-pill badge-light-secondary mr-50" href="#cancel_booking_orders{{$order->id}}" role="button" data-toggle="modal">
                                                                    ...
                                                                    <!--Form cancel product -->
                                                                    <div id="cancel_booking_orders{{$order->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                ...
                                                                                <form id="FormCancelBooking" action="javascript:void(0)">
                                                                                    @csrf
                                                                                    <input name="order_id" value="{{$order->id}}" type="hidden" />
                                                                                    <div class="modal-body">
                                                                                        <div class="form-group">
                                                                                            <label for="account-name">{{__('common.notes')}}</label>
                                                                                            <textarea type="text" class="form-control" id="notes" placeholder="{{__('common.notes')}}" name="store_notes" rows="3"></textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="modal-footer">
                                                                                        <button class="btn default" data-dismiss="modal" aria-hidden="true">{{__('common.cancel')}}</button>
                                                                                        <button class="btn btn-secondary" id="cancel_booking_orders_btn">{{__('common.cancel_booking_orders')}}</button>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="tab-pane" id="inprocess" aria-labelledby="profile-tab" role="tabpanel">
                                        <!-- Basic Tables start -->
                                        <div class="row" id="basic-table">
                                            <div class="col-12">
                                                <div class="card">
                                    ...
                                    <div class="tab-pane" id="canceled_bookings" aria-labelledby="disabled-tab" role="tabpanel">
                                        <!-- Basic Tables start -->
                                        <div class="row" id="basic-table">
                                            <div class="col-12">
                                                <div class="card">
                            ...
                            <table class="table">
                                ...
                                <tbody id="menu">
                                    ...
                                    <tr id="tr-{{$item->id}}">
                                        ...
                                        <td>{{$item->length }}</td>
                                        @if($item->status == 0)
                                            <td><span class="badge badge-pill badge-light-danger mr-1">{{__('common.not_active')}}</span></td>
                                        @else
                                            <td><span class="badge badge-pill badge-light-success mr-1">{{__('common.active')}}</span></td>
                                        @endif
                                        <td><span class="badge badge-pill badge-light-success mr-1">{{ $item->created_at }}</span></td>
...
<div id="extra_space" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
    <div class="modal-dialog" style="max-width:65%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{url(app()->getLocale().'/extra_space')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                    {{ csrf_field() }} 
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.message === 'Success') {
                        ...
                        $('#return_from_store' + response.item.product_id).html('{{__('common.Return_request_sent')}}')
