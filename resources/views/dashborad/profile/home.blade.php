                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2 mb-md-0">
                        <ul class="nav nav-pills flex-column nav-left">
                            ...
                            @can('roles.vendor')
                            <li class="nav-item">
                                <a class="nav-link" id="account-pill-password" data-toggle="pill" href="#chats" aria-expanded="false">
                                    <span class="iconify" class="font-medium-3 mr-1" style="font-size: 19px;margin-left: 15px;" data-icon="bxs:message"></span>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                        <!-- form -->
                                        <form method="post" action="{{url(app()->getLocale().'/managers/'.$user->id)}}" enctype="multipart/form-data" class="validate-form mt-2" role="form">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" id="account-e-mail" name="email" placeholder="Email" value="{{ old('email',$user->email) }}" />
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="account-company">{{__('common.mobile')}}</label>
                                                        <input type="text" class="form-control" id="mobile" placeholder="mobile" name="mobile" value="{{ old('mobile',$user->mobile) }}">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                        <!-- form -->
                                        <form method="post" action="{{url(app()->getLocale().'/managers/'.$user->id.'/edit_password')}}" enctype="multipart/form-data" class="validate-form" role="form">
                                            {{ csrf_field() }}
                                    ...
                                    @can('roles.vendor')
                                    <!-- information -->
                                    <div class="tab-pane fade" id="chats" role="tabpanel" aria-labelledby="account-pill-info" aria-expanded="false">
                                            ...
                                            <div class="row match-height">
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    <div class="card card-user-timeline">
                                                        ...
                                                        <div class="card-body">
                                                            <ul class="timeline ml-50" id="messages" style="overflow-y: scroll;height:400px;">
