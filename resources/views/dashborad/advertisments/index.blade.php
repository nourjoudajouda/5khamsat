                                                            ...
                                                            <tbody id="menu_new">
                                                                ...
                                                                <tr id="tr_new-{{$product->id}}">
                                                                    ...
                                                                    <td>
                                                                        <div class="switch">
                                                                            <!-- <input type="checkbox"> -->
                                                                            <input data-id="{{$product->id}}" class="toggle-class{{$product->id}}" onclick="change_status({{$product->id}})" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" @if($product->promotion == 1) checked @endif>
                                                            ...
                                                            <tbody id="menu">
                                                                ...
                                                                <tr id="tr-{{$product->id}}">
                                                                    ...
                                                                    <td>
                                                                        <div class="switch">
                                                                            <!-- <input type="checkbox"> -->
                                                                            <input data-id="{{$product->id}}" class="toggle-class{{$product->id}}" onclick="change_status({{$product->id}})" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $product->promotion ? 'checked' : '' }}>
