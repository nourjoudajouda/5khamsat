                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">{{__('common.form')}}:</label>
                                        <div class="col-sm-10">
                                ...
                                <div class="col-5">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">{{__('common.to')}}:</label>
                                        <div class="col-sm-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" aria-controls="home" role="tab" aria-selected="true">{{__('common.National_Identity')}}</a>
                            </li>
                            <li class="nav-item">
                                                        ...
                                                        <tr id="tr-{{$item->id}}">
                                                            ...
                                                            <td>
                                                                <a href="{{url('export_excel'.'/'. $item->id)}}">
                                                                    <span class="iconify" style="color: #32c975;font-size: 25px;" data-icon="akar-icons:cloud-download"></span>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <!-- Modal -->
                                                        <div class="modal fade text-left" id="national_identity{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                                        ...
                                                                        <div class="row" style="overflow-y: scroll;height: 250px;">
                                                                            <div class="col-12">
                                                                                ...
                                                                                <div class="block_invoice pt-1">
                                                                                    ...
                                                                                    <h6>{{__('common.Invoice')}}: {{$order->invoice_no}}</h6>
                                                                                    <h6>{{__('common.name_client')}}: {{$order->users->name}}</h6>
                                                                                    <h6>{{__('common.amount')}}: ${{$order->final_price}}</h6>
                                                                                </div>
                                                                                @endforeach
                                                                            </div>
                                                                        </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody class="menu_vendors">
                                                        ...
                                                        <tr id="tr-{{$item->id}}">
                                                            ...
                                                            <td><span class="badge badge-pill badge-light-secondary mr-1" data-toggle="modal" data-target="#national_identity{{$item->id}}">{{ $item->orders_count }}</span></td>
                                                            <td>
                                                                <a href="{{url('export_excel'.'/'. $item->id)}}">
                                                                    <span class="iconify" style="color: #32c975;font-size: 25px;" data-icon="akar-icons:cloud-download"></span>
                                                                </a>
                        ...
                        response.vendors.forEach(function(item) {
                            if(item.orders.length > 0){
                                item.orders.forEach(function(order) {
                                    ...
                                    $('.menu_vendors').prepend('<tr id="tr-' + item.id + '"><td><span class="font-weight-bold">' + item.name + '</span></td><td>' + item.orders_sum_final_price + '</td><td><span class="badge badge-pill badge-light-success mr-1" data-toggle="modal" data-target="#national_identity'+item.id+'">'+item.orders_count+'</span></td><td><a href="{{url('export_excel')}}/'+item.id+'"><span class="iconify" style="color: #32c975;font-size: 25px;" data-icon="akar-icons:cloud-download"></span></a></td></tr>')
                                    $('.menu_vendors').prepend(' <div class="modal fade text-left" id="national_identity'+item.id+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">'+
                                                                    '<div class="modal-dialog" role="document" style="max-width:750px;">'+
                                                                        '<div class="modal-content">'+
                                                                            '<div class="modal-header">'+
                                                                                '<h4 class="modal-title" id="myModalLabel1">{{__('common.invoices')}}</h4>'+
