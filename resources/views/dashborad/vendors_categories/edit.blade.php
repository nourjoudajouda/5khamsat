            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{__('common.edit_vendors_categories')}}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{url('/home')}}">{{__('common.home')}}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">{{__('common.edit_vendors_categories')}}</a>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{url(app()->getLocale().'/vendor_category/'.$category->id)}}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-2 col-form-label">
                                                        <label for="first-name">{{__('common.number_of_orders')}}</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                                        <input id="t-text" type="number" name="number_of_orders" placeholder="{{__('common.number_of_orders')}}" class="form-control" value="{{$category->number_of_orders}}" required />
                                                    </div>
                                                </div>
                                            </div>
