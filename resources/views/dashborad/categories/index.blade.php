        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{__('common.main_categories')}}</h2>
                                ...
                                <tbody id="menu">
                                    ...
                                    <tr id="tr-{{$category->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url(app()->getLocale().'/categories/'.$category->id.'/edit')}}">
                                                <div class="badge badge-pill badge-light-primary mr-50">
                                                    {{__('common.edit')}}
                                                </div>
                                            </a>
                                            <a href="{{url(app()->getLocale().'/categories/'.$category->id)}}">
...
<div id="category_fadeupModal" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
    <div class="modal-dialog" style="max-width:65%;">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('common.add_new_category')}}</h5>
            ...
            <div class="modal-body">
                <form method="post" action="{{url(app()->getLocale().'/categories')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.persent')}}</label>
                                <input id="t-text" type="number" name="persent" placeholder="{{__('common.persent')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-12 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.min_promotion')}}</label>
                                <input id="t-text" type="number" name="min_promotion" placeholder="{{__('common.min_promotion')}}" class="form-control" required>
                            </div>
                        </div>
...
<script>
    function delete_adv(id) {
        // alert(1);
        var url = '{{url(app()->getLocale()."/categories")}}/' + id;
