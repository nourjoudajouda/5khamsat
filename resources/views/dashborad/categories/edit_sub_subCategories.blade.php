                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{url(app()->getLocale().'/sub_sub_category/'.$category->id)}}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="row"> 
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="main_parent" class="form-control" onchange="get_sub_category(this)">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-2 col-form-label">
                                                        <label for="first-name">{{__('common.sub_category_name')}}</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                                        <select name="sub_parent" class="form-control" id="sub_category">
                                                            @foreach($sub_categories as $sub_category)
                                                                <option value="{{$sub_category->id}}" @if($sub_category->id == $category->sub_parent) selected @endif>
                                                                    @if(app()->getLocale() == 'en')
