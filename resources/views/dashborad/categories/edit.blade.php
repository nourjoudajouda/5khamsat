                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{url(app()->getLocale().'/category/'.$category->id)}}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-2 col-form-label">
                                                        <label for="first-name">{{__('common.persent')}}</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                                        <input id="t-text" type="number" name="persent" placeholder="{{__('common.persent')}}" class="form-control" value="{{$category->persent}}" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-2 col-form-label">
                                                        <label for="first-name">{{__('common.min_promotion')}}</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                                        <input id="t-text" type="number" name="min_promotion" placeholder="{{__('common.min_promotion')}}" class="form-control" value="{{$category->min_promotion}}" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
