        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        <button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" data-toggle="modal" data-target="#category_fadeupModal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('common.add_new_sub_sub_category')}}</button>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody id="menu">
                                    ...
                                    <tr id="tr-{{$category->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url(app()->getLocale().'/sub_sub_categories/'.$category->id.'/edit')}}">
...
<div id="category_fadeupModal" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
    <div class="modal-dialog" style="max-width:65%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{url(app()->getLocale().'/sub_sub_categories')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                    {{ csrf_field() }}

                    <input type="hidden" name="main_parent" value="{{$main_category->id}}" />
                    <input type="hidden" name="sub_parent" value="{{$sub_category->id}}" />
                    <div class="row">
...
<script>
    function delete_adv(id) {
        // alert(1);
        var url = '{{url(app()->getLocale()."/sub_sub_categories")}}/' + id;
