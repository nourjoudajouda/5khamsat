        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{__('common.sub_categories')}}</h2>
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        <button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" data-toggle="modal" data-target="#category_fadeupModal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('common.add_new_sub_category')}}</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody id="menu">
                                    ...
                                    <tr id="tr-{{$category->id}}">
                                        ...
                                        <td>
                                            <img src="{{$category->image}}" style="height: 50px;" alt="Image Category" />
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url(app()->getLocale().'/sub_categories/'.$category->id.'/edit')}}">
                                                <div class="badge badge-pill badge-light-primary mr-50">
                                                    {{__('common.edit')}}
                                                </div>
                                            </a>
                                            <a href="{{url(app()->getLocale().'/sub_categories/'.$category->id)}}">
                                                <div class="badge badge-pill badge-light-warning mr-50">
                                                    {{__('common.view_sub_categories')}}
                                                </div>
                                            </a>
...
<div id="category_fadeupModal" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
    <div class="modal-dialog" style="max-width:65%;">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('common.add_new_sub_category')}}</h5>
            ...
            <div class="modal-body">
                <form method="post" action="{{url(app()->getLocale().'/sub_categories')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                    {{ csrf_field() }}
                    <input type="hidden" name="main_parent" value="{{$main_category->id}}" />
                    <div class="row">
...
<script>
    function delete_adv(id) {
        // alert(1);
        var url = '{{url(app()->getLocale()."/sub_categories")}}/' + id;
