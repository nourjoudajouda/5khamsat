                    ...
                    <section id="dashboard-ecommerce">
                            ...
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="card card-congratulation-medal">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text font-small-3">{{ __('common.sales_number') }} :
                                            {{ $daily_orders_admin->sum('order_details_count') }}</p>
                                        <h3 class="mb-75 mt-2 pt-50">
                                            <a href="javascript:void(0);">${{ $daily_orders_admin->sum('final_price') }}</a>
                                        </h3>
                                        <a href="{{ url('orders') }}">
                                            <button type="button"
                                                class="btn btn-primary">{{ __('common.View Sales') }}</button>
                                        </a>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <p class="card-text font-small-2 mr-25 mb-0">
                                                <select class="form-control" id="select_duraiton"
                                                    onchange="update_statistics('admin')">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0" id="total_sales">
                                                            ${{ $daily_orders_admin->sum('final_price') }}</h4>
                                                        <p class="card-text font-small-3 mb-0">{{ __('common.Total sales') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0" id="count_users">
                                                            {{ count($daily_users_admin) }}</h4>
                                                        <p class="card-text font-small-3 mb-0">
                                                            {{ __('common.number customers') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0" id="count_sales">
                                                            {{ $daily_orders_admin->sum('order_details_count') }}</h4>
                                                        <p class="card-text font-small-3 mb-0">{{ __('common.number sales') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0" id="revenue">
                                                            ${{ $daily_orders_admin->sum('system_commission') }}</h4>
                        ...
                        <div class="row match-height" style="margin-bottom: 20px;">
                            ...
                            <div class="col-xl-2 col-md-2 col-12">
                                <a href="{{ url('/vendors') }}">
                                    <div class="bg-statstice"
                                        style="background: #fff;padding: 15px;border-radius: 0.428rem;display:flex">
                                        <div class="avatar bg-light-success mr-2">
                                                                ...
                                                                <a
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar rounded">
                                                                            <div class="avatar-content">
                                                                                <img src="{{ $vendor->data->ID_image }}"
                                                                                    style="height: 30px;border-radius: 50%;width:100%;"
                                                                                    alt="Toolbar svg" />
                                                                            </div>
                                                                        </div>
                                                                        <div>
                                                ...
                                                <tbody>
                                                    @foreach ($last_users_admin as $client)
                                                        <tr>
                                                            <td>
                                                                <a
                                                                    href="{{ url(app()->getLocale() . '/clients/' . $client->id) }}">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar rounded">
                                                                            <div class="avatar-content">
                                                            ...
                                                            <td>
                                                                <a href="{{ url(app()->getLocale() . '/orders/' . $order->id) }}">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <div class="font-weight-bolder">
                                                                                {{ $order->users->name }}</div>
                                                                            <div class="font-small-2 text-muted">
                                                                                {{ $order->users->email }}</div>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                            </td>
                                                            <td>
                                                                ...
                                                                @else
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar rounded">
                                                                            <div class="avatar-content">
                                                                                <img src="{{ $order->vendors->data->ID_image }}"
                                                                                    style="height: 30px;border-radius: 50%;width:100%;"
                                                                                    alt="Toolbar svg" />
                                                                            </div>
                                                                        </div>
                                                                        <div>
                                                                            <div class="font-weight-bolder">
                                                                                {{ $order->vendors->name }}</div>
                                                                            <div class="font-small-2 text-muted">
                                                                                {{ $order->vendors->email }}</div>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                            </td>
                                    ...
                                    <div class="card-body">
                                        @foreach ($top_rated_countries as $country)
                                            <div class="browser-states">
                                                <div class="media">
                                                    <!-- <img src="{{ url('dashborad/app-assets/images/icons/google-chrome.png') }}" class="rounded mr-1" height="30" alt="Google Chrome" /> -->
                                ...
                                <div class="card card-browser-states">
                                    ...
                                    <div class="card-body">
                                        @foreach ($top_rated_users as $user)
                                            <div class="browser-states">
                                                <div class="media">
                                                    <img src="{{ $user->photo }}" class="rounded mr-1" height="30"
                                                        alt="Google Chrome" />
                                                    <h6 class="align-self-center mb-0">{{ $user->name }}</h6>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <div class="font-weight-bold text-body-heading mr-1">
                                                        ${{ $user->orders->sum('final_price') }}</div>
                                                    <!-- <div id="browser-state-chart-primary"></div> -->
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                <div class="card card-browser-states">
                                    ...
                                    <div class="card-body">
                                        @foreach ($top_rated_products as $product)
                                            <div class="browser-states">
                                                <div class="media">
                                                    <img src="{{ $product->image }}" class="rounded mr-1" height="30"
                                                        alt="Google Chrome" />
                                                    <h6 class="align-self-center mb-0">
                                                        @if (app()->getLocale() == 'en')
                                                            {{ $product->name_en }}
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="font-weight-bold text-body-heading mr-1">
                                                        {{ $product->orders->sum('quantity') }} {{ __('common.unit') }}</div>
                                                    <!-- <div id="browser-state-chart-primary"></div> -->
                                                </div>
                                            </div>
                                        @endforeach
                                                ...
                                                <tbody>
                                                    @foreach ($accepted_bookings as $order)
                                                        <tr id="tr_new-{{ $order->id }}">
                                                            ...
                                                            <td><span
                                                                    class="badge badge-pill badge-light-info mr-1">{{ $order->area }}</span>
                                                            </td>
                                                            <td><span
                                                                    class="badge badge-pill badge-light-primary mr-1">{{ $order->price }}</span>
                                                            </td>
                            ...
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="card card-congratulation-medal">
                                    <div class="card-body">
                                        <h5>{{ __('common.daily_sales') }}</h5>
                                        <p class="card-text font-small-3">{{ __('common.sales_number') }} :
                                            {{ count($daily_orders_vendors) }}</p>
                                        <h3 class="mb-75 mt-2 pt-50">
                                            <a
                                                href="javascript:void(0);">${{ $daily_orders_vendors->sum('final_price') }}</a>
                                        </h3>
                                        <a href="{{ url('orders') }}">
                                            <button type="button"
                                                class="btn btn-primary">{{ __('common.View Sales') }}</button>
                                ...
                                <div class="card card-statistics">
                                    <div class="card-header">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <p class="card-text font-small-2 mr-25 mb-0">
                                                <select class="form-control" id="select_duraiton"
                                                    onchange="update_statistics('vendor')">
                                                    <option value="daily">{{ __('common.last_date') }}</option>
                                                    <option value="monthly">{{ __('common.last_month') }}</option>
                                                    <option value="yearly">{{ __('common.last_year') }}</option>
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0" id="total_sales">
                                                            ${{ $daily_orders_vendors->sum('final_price') }}</h4>
                                                        <p class="card-text font-small-3 mb-0">{{ __('common.Total sales') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0" id="count_sales">
                                                            {{ count($daily_orders_vendors) }}</h4>
                                                        <p class="card-text font-small-3 mb-0">
                                                            {{ __('common.number sales') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-6 col-12">
                                        ...
                                        <div class="bg-statstice"
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">
                                                    {{ $points_vendor->points - $points_vendor->points_spent }}</h4>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-nowrap">
                                                                <div class="d-flex flex-column">
                                                                    <span
                                                                        class="font-weight-bolder mb-25">{{ $order->final_price }}
                                                                        $</span>
                                                                </div>
                                                            </td>
                                                    ...
                                                    @if ($new_shippments_orders != null)
                                                        @foreach ($new_shippments_orders as $order)
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="avatar rounded">
                                                                            <div class="avatar-content">
                                                                                <img src="{{ $order->vendors->data->ID_image }}"
                                                                                    style="height: 36px;border-radius: 10px;width: 100%;"
                                                                                    alt="Toolbar svg" />
                                                                            </div>
                                                                        </div>
                                                                        <div>
                                                                ...
                                                                @if ($order->status == 0)
                                                                    <td><span
                                                                            class="badge badge-pill badge-light-info mr-1">{{ __('common.new') }}</span>
                                                                    </td>
                                                                @elseif($order->status == 1)
                                                                    <td><span
                                                                            class="badge badge-pill badge-light-success mr-1">{{ __('common.stored') }}</span>
                                                                    </td>
                                                                @elseif($order->status == 2)
                                                                    <td><span
                                                                            class="badge badge-pill badge-light-success mr-1">{{ __('common.inprocess') }}</span>
                                                                    </td>
                                                                @elseif($order->status == 3)
                                                                    <td><span
                                                                            class="badge badge-pill badge-light-success mr-1">{{ __('common.finished') }}</span>
                                                                    </td>
                                                                @elseif($order->status == 4)
                                                                    <td><span
                                                                            class="badge badge-pill badge-light-secondary mr-1">{{ __('common.inprocess') }}</span>
                                                                    </td>
                                                                @endif
                                                                <td><span
                                                                        class="badge badge-pill badge-light-success mr-1">{{ $order->created_at }}</span>
