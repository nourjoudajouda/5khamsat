                                                            ...
                                                            <tbody> 
                                                                ...
                                                                <tr id="tr-{{$order->id}}">
                                                                    ...
                                                                    <td>
                                                                       ...
                                                                       <select onchange="change_status({{$order->id}})" id="accept_order{{$order->id}}" name="accept_order" data-price="{{$order->final_price}}" data-value_added_tax="{{$order->value_added_tax}}" data-system_commission="{{$order->system_commission}}" data-incomming_tax="{{$order->incomming_tax}}"class="form-control">
                                                                           <option value="0">{{__('common.status')}}</option>
                                                                           <option value="1">{{__('common.accept')}}</option>
                                                                           <option value="3">{{__('common.cancel')}}</option>
                                                                       </select>
                                                                    </td>
                                                                    @endcan
                                                                    <td>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr id="tr-{{$order->id}}">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex justify-content-between" id="switch_activate" style="margin-bottom: 10px;">
                                                                            <div class="custom-control custom-switch"> 
                                                                                <input type="checkbox" id="paymentTerms{{$order->id}}" class="custom-control-input toggle-class{{$order->id}}" data-id="{{$order->id}}" onclick="change_accepted_status({{$order->id}})" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $order->status ? 'checked' : '' }} />
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <!-- Convert Order -->
                                                                <div id="convert_fadeupModal{{$order->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                                                    <div class="modal-dialog">
                                                                        <!-- Modal content-->
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">{{__('common.convert_order')}}</h5>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12 col-12 mx-auto">
                                                                                        <div style="margin-bottom: 20px;">
                                                                                            <label for="t-text" class="">{{__('common.name_vendor')}}</label>
                                                                                ...
                                                                                <div class="modal-footer md-button">
                                                                                    ...
                                                                                    <button id="btn-bg" class="btn btn-primary" onclick="convert_order({{$order->id}})">{{__('common.save')}}</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
    ...
    $(window).on('load', function () {
        ...
        if (confirmColor.length) {
            ...
            Swal.fire({
                ...
                text: "",
                html:
                '{{__('common.value_added_tax')}} : <b>{{$settings->value_added_tax}}</b><br/><br/>' +
