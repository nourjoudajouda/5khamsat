...
@section('content')
                                            ...
                                            <div class="user-avatar-section">
                                                <div class="d-flex justify-content-start">
                                                    @if ($vendor->data->ID_image)
                                                        <img class="img-fluid rounded" src="{{ $vendor->data->ID_image }}"
                                                    ...
                                                    <div class="d-flex flex-column ml-1">
                                                        ...
                                                        <div class="d-flex flex-wrap">
                                                            ...
                                                            <a href="#myModal{{ $vendor->id }}" role="button"
                                                                data-toggle="modal">
                                                                <button
                                                ...
                                                <div class="d-flex flex-wrap mt-3 text-center">
                                                    ...
                                                    <div class="badge badge-pill badge-light-secondary"
                                                        style="width: 83%;height: 25px;padding: 7px;">
                                                        @if (app()->getLocale() == 'en')
                                            ...
                                            <div class="user-info-wrapper">
                                                <div class="d-flex flex-wrap">
                                                    <div class="user-info-title">
                                                        ...
                                                        <span
                                                            class="card-text user-info-title font-weight-bold mb-0">{{ __('common.vendor_legal_data') }}</span>
                                                    </div>
                                                ...
                                                <div class="d-flex flex-wrap my-50">
                                                    ...
                                                    <div class="item-rating">
                                                        <ul class="unstyled-list list-inline">
                                                            ...
                                                            @endfor
                                                            @if ($vendor->users->rate < 5)
                                                                @for ($i = 1; $i <= 5 - $vendor->users->rate; $i++)
                                                                    <li class="ratings-list-item"><i data-feather="star"
                                            ...
                                            <div class="d-flex align-items-center user-total-numbers">
                                                <div class="d-flex align-items-center" style="width: 100%;">
                                                    <div class="d-flex align-items-center mr-2" style="width: 100%;">
                                                        <a href="{{ url(app()->getLocale() . '/chats/' . $vendor->id) }}"
                                                            class="btn btn-outline-warning btn-block mb-75"
                                                            style="position: relative;top: 9px;">
                                                            {{ __('common.connect_with_trader') }}
                                                        </a>
                                                    </div>
                                                    <div class="d-flex align-items-center mr-2" style="width: 100%;">
                                                        <a href="{{ url(app()->getLocale() . '/documents/' . $vendor->id) }}"
                                                            class="btn btn-outline-success btn-block mb-75"
                                                            style="position: relative;top: 9px;">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5">
                            <div class="card plan-card border-primary">
                                <div class="card-header d-flex justify-content-between align-items-center pt-75 pb-1"
                                    style="border-bottom: 1px solid #f4f4f5;margin-bottom:15px;">
                                    <h5 class="mb-0">{{ __('common.Portfolio') }}</h5>
                                    @if ($vendor_balance)
                                        <span class="badge badge-light-secondary" data-toggle="tooltip"
                                            data-placement="top" title="Expiry Date">{{ $vendor_balance->balance }}
                                        </span>
                                    @endif
                                </div>
                                @if ($vendor_balance)
                                    <div class="card-body">
                                        ...
                                        <div class="badge badge-light-warning" style="float: left;">
                                            {{ __('common.currency') }}</div>

                                        <div class="row pt-75 pb-1">
                                            <div class="col-lg-6">
                                                <div class="badge badge-light-secondary">{{ $vendor_balance->balance }}
                                                </div>
                                            </div>
                                            <div class="col-lg-6" style="text-align:end;">
                                                <div class="badge badge-light-secondary">
                                                    {{ $vendor_balance->icon_currency }}</div>
                                            </div>
                                        </div>
                                        <a href="{{ url('/portfolio/' . $vendor->id) }}">
                                            <button
                                                class="btn btn-primary text-center btn-block">{{ __('common.details') }}</button>
                                        </a>
                                        <a href="{{ url('/taxs/' . $vendor->id) }}">
                                            <button class="btn btn-outline-primary text-center btn-block"
                                                style="margin-top: 5px;">{{ __('common.taxs') }}</button>
                                        </a>
                                    </div>
                                @endif
                            </div>
                                                ...
                                                <tbody>
                                                    @foreach ($rates as $rate)
                                                        <tr id="tr-{{ $rate->id }}">
                                                            ...
                                                            <td style="padding: 0.72rem;">
                                                                <span
                                                                    class="badge badge-pill badge-light-success mr-1">{{ $rate->created_at }}</span>
                                                                <span class="badge badge-pill badge-light-warning mr-1"
                                                                    data-toggle="modal"
                                                                    data-target="#default{{ $rate->id }}"><i
                                    ...
                                    @foreach ($new_shippment as $order)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="iconify" data-toggle="modal"
                                                    data-target="#new_shippment{{ $rate->id }}"
                                                    style="font-size:20px;color:#fec53a"
                                                    id="new_shippment{{ $order->id }}"
                                                    data-icon="fluent:more-circle-32-filled"></span>
                                            </td>
                                            <!-- Modal -->
                                            <div class="modal fade text-left" id="new_shippment{{ $order->id }}"
                                                                ...
                                                                <div class="col-12">
                                                                    @foreach ($order->details_shippment as $item)
                                                                        <div class="block_item pt-1">
                                                                            ...
                                                                            <h6>{{ __('common.name_store') }}:
                                                                                {{ $item->stores->company_name }}</h6>
                                                                            <h6>{{ __('common.name_branche') }}:
                                                                                {{ $item->branches->name_ar }}</h6>
                                                                            <h6>{{ __('common.name_product') }}:
                                                                                {{ $item->products->name_ar }}</h6>
                                                                            <h6>{{ __('common.Qty') }}:
                                                                                {{ $item->product_qty }}</h6>
                                                                            <h6>{{ __('common.area') }}:
                                                                                {{ $item->total_volume }}</h6>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                                            ...
                                            @foreach ($contacts as $contact)
                                                <li class="nav-item" style="display:flex;margin-bottom:25px;">
                                                    <div class="avatar mr-50">
                                                        <img src="{{ $contact->users->photo }}" alt="Avatar"
                                                            width="38" height="38" />
                                                    </div>
                                                    <a class="nav-link {{ $loop->first ? 'active' : '' }}"
                                                        ...
                                                        aria-selected="true">{{ $contact->users->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                        <div class="tab-content">
                                            @foreach ($contacts as $contact)
                                                <div class="tab-pane {{ $loop->first ? 'active' : '' }}"
                                                    id="tabVerticalLeft{{ $contact->id }}"
                                                    style="overflow-y: scroll;height:500px;" role="tabpanel"
    ...
    @if ($vendor->users->whatsapp != null)
        <a href="https://api.whatsapp.com/send?phone={{ $vendor->users->whatsapp }}" target="blank">
            <img src="{{ url('dashborad/app-assets/images/whatsapp.gif') }}"
                style="z-index: 1000;height: 55px;position: fixed;bottom: 70px;left: 20px;" />
        </a>
    @endif

    <!--Form Delete -->
    <div id="myModal{{ $vendor->id }}" class="modal fade" tabindex="-1" role="dialog"
