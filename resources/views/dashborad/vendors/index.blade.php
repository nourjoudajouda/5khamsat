            ...
            <div class="content-header-right text-md-right col-md-6 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        ...
                        <button class="btn-icon btn btn-outline-success btn-round btn-sm dropdown-toggle" onclick="collection_commission()" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('common.collection_commission')}}</button>
                        <button class="btn-icon btn btn-outline-info btn-round btn-sm dropdown-toggle" id="calculate_taxs" onclick="calculating_commission()" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('common.calculating_commission')}}</button>
                        <button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" data-toggle="modal" data-target="#vendor_fadeupModal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('common.add_new_vendor')}}</button>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="new-tab" data-toggle="tab" href="#new" aria-controls="new" role="tab" aria-selected="true">{{__('common.new_vendors')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="active-tab" data-toggle="tab" href="#active" aria-controls="active" role="tab" aria-selected="false">{{__('common.active_vendors')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="order-tab" data-toggle="tab" href="#order" aria-controls="order" role="tab" aria-selected="false">{{__('common.not_active_vendors')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="rejected_vendors-tab" data-toggle="tab" href="#rejected_vendors" aria-controls="order" role="tab" aria-selected="false">{{__('common.rejected_vendors')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="rejected_vendors_system-tab" data-toggle="tab" href="#rejected_vendors_system" aria-controls="order" role="tab" aria-selected="false">{{__('common.rejected_vendors_system')}}</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody id="menu">
                                                                ...
                                                                <tr id="tr-{{$vendor->id}}">
                                                                    ...
                                                                    <td style="text-align: center;"><span class="badge badge-pill badge-light-success mr-1">{{ $vendor->what_kind_products }}</span></td>
                                                                    <td>
                                                                        <div class="d-flex justify-content-between" id="switch_activate" style="margin-bottom: 10px;">
                                                                            <div class="custom-control custom-switch">
                                                                                <input type="checkbox" id="paymentTerms{{$vendor->id}}" class="custom-control-input toggle-class{{$vendor->id}}" data-id="{{$vendor->id}}" onclick="change_status({{$vendor->id}})" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $vendor->status ? 'checked' : '' }} />
                                                                                <label class="custom-control-label" for="paymentTerms{{$vendor->id}}"></label>
                                                                            </div>
                                                                        </div>
                                                     
                                                                    </td>
                                                                    <td>
                                                                        <div class="badge badge-pill badge-light-danger mr-50" href="#myModal{{$vendor->id}}" role="button" data-toggle="modal">
                                                                            {{__('common.delete')}}
                                                                        </div>
                                                                        <a href="{{url(app()->getLocale().'/vendors/'.$vendor->id.'/edit')}}">
                                                                        ...
                                                                        <div class="badge badge-pill badge-light-secondary mr-50" href="#reject_vendor{{$vendor->id}}" role="button" data-toggle="modal">
                                                                            {{__('common.reject_vendor')}}
                                                                        </div>
                                                                        <div class="badge badge-pill" data-toggle="modal" data-target="#message_fadeupModal{{$vendor->id}}">
                                                                            <img src="{{url('public/dashborad/app-assets/images/mail.svg')}}" style="cursor: pointer;" alt />
                                                                        </div>
                                                                        <div class="badge badge-pill" data-toggle="modal" data-target="#mobile_fadeupModal{{$vendor->id}}">
                                                                            <img src="{{url('public/dashborad/app-assets/images/smartphone.svg')}}" style="cursor: pointer;" alt />
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <!--Message-->
                                                                <div id="message_fadeupModal{{$vendor->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                                                    <div class="modal-dialog">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="post" action="{{url(app()->getLocale().'/send_message')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                                                                                    {{ csrf_field() }}
                                                                                    <div class="row">
                                                                                        <div class="col-lg-12 col-12 mx-auto">
                                                                                            <div style="margin-bottom: 20px;">
                                                                                                <label for="t-text" class="">{{__('common.message')}}</label>
                                                                ...
                                                                <!--Mobile-->
                                                                <div id="mobile_fadeupModal{{$vendor->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                                                    <div class="modal-dialog">
                                                                        <!-- Modal content-->
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button class="btn btn-danger" onclick="delete_adv({{$vendor->id}})">{{__('common.delete')}}</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!-- End Form Delete -->
                                                                  ...
                                                                  <!--Form Reject -->
                                                                  <div id="reject_vendor{{$vendor->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button> -->
                                                                            ...
                                                                            <form id="FormRejectVendor" action="javascript:void(0)">
                                                                                @csrf
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button class="btn default" data-dismiss="modal" aria-hidden="true">{{__('common.cancel')}}</button>
                                                                                    <button class="btn btn-secondary" id="reject_vendor_btn">{{__('common.reject_vendor')}}</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <table class="table" style="overflow-x: auto;white-space: nowrap;">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>{{__('common.Total_commission_payable')}}</th>
                                                                    <th>{{__('common.status')}}</th>
                                                                    <th>{{__('common.actions')}}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="menu">
                                                                ...
                                                                <tr id="tr-{{$vendor->id}}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <span class="badge badge-pill badge-light-info mr-1">{{ $vendor->activators->name }}</span>
                                                                        @else
                                                                        <span class="badge badge-pill badge-light-danger mr-1">{{__('common.not_active')}}</span>
                                                                        @endif
                                                                    </td>
                                                                    <td style="text-align: center;"><span class="badge badge-pill badge-light-success mr-1">{{ $vendor->what_kind_products }}</span></td>
                                                                    <td>${{ $vendor->orders->sum('incomming_tax') + $vendor->orders->sum('value_added_tax') }}</td>
                                                                    <td>${{ $vendor->orders->sum('system_commission')}}</td>
                                                                    <td>

                                                                        <div class="d-flex justify-content-between" id="switch_activate" style="margin-bottom: 10px;">
                                                                            <div class="custom-control custom-switch">
                                                                                <input type="checkbox" id="paymentTerms{{$vendor->id}}" data-toggle="modal" data-target="#status_fadeupModal{{$vendor->id}}" class="custom-control-input toggle-active-vendor-class{{$vendor->id}}" data-id="{{$vendor->id}}"  type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" @if($vendor->status == 1) checked @endif />
                                                                                <label class="custom-control-label" for="paymentTerms{{$vendor->id}}"></label>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                 ...
                                                                 <!--Status-->
                                                                <div id="status_fadeupModal{{$vendor->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                                                    <div class="modal-dialog">
                                                                        <!-- Modal content-->
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form id="FormCancelVendor" action="javascript:void(0)">
                                                                                    @csrf
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        <button class="btn default" data-dismiss="modal" aria-hidden="true">{{__('common.cancel')}}</button>
                                                                                        <button class="btn btn-secondary" data-id="{{$vendor->id}}" id="cancel_vendor_btn">{{__('common.disactive_vendor')}}</button>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <tbody id="menu">
                                                                ...
                                                                <tr id="tr-{{$vendor->id}}">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex justify-content-between" id="switch_activate" style="margin-bottom: 10px;">
                                                                            <div class="custom-control custom-switch">
                                                                            <input type="checkbox" id="paymentTerms{{$vendor->id}}" class="custom-control-input toggle-active-vendor-class{{$vendor->id}}" data-id="{{$vendor->id}}" onclick="change_active_vendor_status({{$vendor->id}})" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" @if($vendor->status == 1) checked @endif />
                                                                                <label class="custom-control-label" for="paymentTerms{{$vendor->id}}"></label>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                    ...
                                    <div class="tab-pane" id="rejected_vendors" aria-labelledby="disabled-tab" role="tabpanel">
                                        <!-- Basic Tables start -->
                                        <div class="row" id="basic-table">
                                            <div class="col-12">
                                                <div class="card">
                                    ...
                                    <div class="tab-pane" id="rejected_vendors_system" aria-labelledby="disabled-tab" role="tabpanel">
                                        <!-- Basic Tables start -->
                                        <div class="row" id="basic-table">
                                            <div class="col-12">
                                                <div class="card">
...
<div id="vendor_fadeupModal" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
    <div class="modal-dialog" style="max-width:65%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{url(app()->getLocale().'/vendors')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                ...
                                <input type="text" name="name_store" placeholder="{{__('common.name_store')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                ...
                                <input type="text" name="company_legal_name" placeholder="{{__('common.company_legal_name')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                ...
                                <input type="text" name="beneficiay_name" placeholder="{{__('common.beneficiay_name')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.bank_name')}}</label>
                                <input type="text" name="bank_name" placeholder="{{__('common.bank_name')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.branch_name')}}</label>
                                <input type="text" name="branch_name" placeholder="{{__('common.branch_name')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.account_number')}}</label>
                                <input type="text" name="account_number" placeholder="{{__('common.account_number')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.iban_number')}}</label>
                                <input type="text" name="iban_number" placeholder="{{__('common.iban_number')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.swift_code')}}</label>
                                <input type="text" name="swift_code" placeholder="{{__('common.swift_code')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-12 col-12 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.currency')}}</label>
                                <input type="text" name="currency" placeholder="{{__('common.currency')}}" class="form-control" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" data-info="Commercial_Record" href="#home" aria-controls="home" role="tab" aria-selected="true">{{__('common.Commercial_Record')}}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" data-info="freelance_work" aria-controls="profile" role="tab" aria-selected="false">{{__('common.freelance_work')}}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="about-tab" data-toggle="tab" href="#about" data-info="National_Identity" aria-controls="about" role="tab" aria-selected="false">{{__('common.National_Identity')}}</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        ...
                                                        <input type="text" name="Commercial_Registration_No" placeholder="{{__('common.Commercial Registration No')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.Trade Name')}}</label>
                                                        <input type="text" name="Trade_Name" placeholder="{{__('common.Trade Name')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.Brand name')}}</label>
                                                        <input type="text" name="Brand_name" placeholder="{{__('common.Brand name')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.Registry specialty')}}</label>
                                                        <input type="text" name="Registry_specialty" placeholder="{{__('common.Registry specialty')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.Record owner name')}}</label>
                                                        <input type="text" name="Record_owner_name" placeholder="{{__('common.Record owner name')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.Store name')}}</label>
                                                        <input type="text" name="store_name" placeholder="{{__('common.Store name')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.Store Description')}}</label>
                                                        <textarea type="text" name="store_description" placeholder="{{__('common.Store Description')}}" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        ...
                                                        <input type="text" name="Commissioner_name" placeholder="{{__('common.Commissioner_name')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.No.civil_registry')}}</label>
                                                        <input type="text" name="owner_civil_registry_number" placeholder="{{__('common.No.civil_registry')}}" class="form-control">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        ...
                                                        <input type="text" name="Freelance_document_number" placeholder="{{__('common.Freelance_document_number')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.Document_Specialization')}}</label>
                                                        <input type="text" name="Document_Specialization" placeholder="{{__('common.Document_Specialization')}}" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        ...
                                                        <input type="text" name="owner_civil_registry_number" placeholder="{{__('common.The_owner_civil_registry_number')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                ...
                                                <div class="col-lg-6 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        ...
                                                        <input type="text" name="authorized_civil_registry_number" placeholder="{{__('common.authorized_civil_registry_number')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        ...
                                                        <input type="text" name="authorized_name" placeholder="{{__('common.authorized_name')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-12 mx-auto">
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="t-text" class="">{{__('common.owner_name')}}</label>
                                                        <input type="text" name="owner_name" placeholder="{{__('common.owner_name')}}" class="form-control">
                                                    </div>
                                                </div>
