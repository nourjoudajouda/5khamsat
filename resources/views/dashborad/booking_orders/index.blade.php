                                ...
                                <table class="table">
                                    ...
                                    <tbody id="menu_new">
                                        @foreach ($new_bookings as $order)
                                            <tr id="tr_new-{{ $order->id }}">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between" id="switch_activate"
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" id="paymentTerms{{ $order->id }}"
                                                ...
                                                <td style="display: flex;padding-top:23px;">
                                                    <div class="badge badge-pill badge-light-danger mr-50"
                                                        href="#myModal{{ $order->id }}" role="button"
                                                        data-toggle="modal">
                                                        {{ __('common.delete') }}
                                                    </div>
                                                    <div class="badge badge-pill badge-light-secondary mr-50"
                                                        href="#cancel_booking_orders{{ $order->id }}" role="button"
                                                        data-toggle="modal">
                                            ...
                                            <!--Form cancel product -->
                                            <div id="cancel_booking_orders{{ $order->id }}" class="modal fade"
