            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-5 col-12 d-md-block d-none">
                    <div class="form-group breadcrumb-right">
                        <div class="dropdown">
                            <label style="font-weight: bold;color: #fdce5d;font-size: 17px;"> {{ __('common.name_vendor') }}
                                : {{ $shippment->vendors->name }}</label>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody id="menu_new">
                                        @foreach ($products as $product)
                                            <tr id="tr_new-{{ $product->id }}">
                                                ...
                                                <td><span
                                                        class="badge badge-pill badge-light-info mr-1">{{ $product->total_volume }}</span>
                                                </td>
                                                <td><span
                                                ...
                                                <td style="display: flex;padding-top:23px;">
                                                    <a
                                                        href="{{ url(app()->getLocale() . '/products/' . $product->product_id) }}">
