                                ...
                                <table class="table">
                                    ...
                                    <tbody id="menu_new">
                                        @foreach ($extraspaces as $order)
                                            <tr id="tr_new-{{ $order->id }}">
                                                ...
                                                <td style="display: flex;padding-top:23px;">
                                                    ...
                                                    <div class="badge badge-pill badge-light-secondary mr-50"
                                                        href="#cancel_extra_spaces{{ $order->id }}" role="button"
                                                        data-toggle="modal">
                                            ...
                                            <!--Form cancel product -->
                                            <div id="cancel_extra_spaces{{ $order->id }}" class="modal fade"
                                                        ...
                                                        <form id="FormCancelExtraSpace" action="javascript:void(0)">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-secondary"
                                                                    id="cancel_extra_spaces_btn">{{ __('common.cancel_booking_orders') }}</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
