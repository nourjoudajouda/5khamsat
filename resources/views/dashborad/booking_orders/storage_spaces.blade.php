                        ...
                        <div class="form-group breadcrumb-right">
                            <div class="dropdown">
                                <button class="btn-icon btn btn-outline-success btn-round btn-sm dropdown-toggle"
                                    onclick="collection_monthly_invoice()" type="button" data-toggle="dropdown"
                                    aria-haspopup="true"
                                    aria-expanded="false">{{ __('common.collection_monthly_invoice') }}</button>
                                <button class="btn-icon btn btn-outline-info btn-round btn-sm dropdown-toggle"
                                    onclick="calculate_monthly_invoice()" type="button" data-toggle="dropdown"
                                    aria-haspopup="true"
                                    aria-expanded="false">{{ __('common.calculating_monthly_invoice') }}</button>
                            </div>
                        </div>
                    </div>
                @endcan
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                                                ...
                                                aria-selected="true">{{ __('common.acceptted_bookings') }}</a>
                                        </li>
                                                                        ...
                                                                        <tr id="tr_new-{{ $order->id }}">
                                                                            ...
                                                                            @can('roles.stores')
                                                                                <td style="display: flex;padding-top:23px;">
                                                                                    ...
                                                                                    <a
                                                                                        href="{{ url(app()->getLocale() . '/details_booking_orders/' . $order->user_id) }}">
                                                                                        <div
