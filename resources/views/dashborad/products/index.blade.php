        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-5 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        @can('roles.vendor')
                        <button onclick="move_all_products()" class="btn-icon btn btn-info btn-round btn-sm" id="show_many_to_store" type="button" class="btn btn-outline-primary" data-toggle="modal" disabled data-target="#products_list_fadeupModal">{{__('common.move_to_store')}}</button>
                        @endcan
                        @can('products.store')
                        <button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#xlarge">{{__('common.add_new_product')}}</button>
                        @endcan
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" aria-controls="home" role="tab" aria-selected="true">{{__('common.new_products')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" aria-controls="profile" role="tab" aria-selected="false">{{__('common.acceptted_products')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="order-tab" data-toggle="tab" href="#order" aria-controls="order" role="tab" aria-selected="false">{{__('common.canceled_products')}}</a>
                                    </li>
                                </ul>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody id="menu_new">
                                                                ...
                                                                <tr id="tr_new-{{$product->id}}">
                                                                    ...
                                                                    <td>
                                                                        <span class="badge badge-pill badge-light-primary mr-1">{{ $product->qty }}</span>
                                                                    </td>
                                                                    @can('products.activetion')
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex justify-content-between" id="switch_activate" style="margin-bottom: 10px;">
                                                                            <div class="custom-control custom-switch"> 
                                                                                <input type="checkbox" id="paymentTerms{{$product->id}}" class="custom-control-input toggle-class{{$product->id}}" data-id="{{$product->id}}" onclick="change_status({{$product->id}})" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $product->status ? 'checked' : '' }} />
                                                                    ...
                                                                    <td style="display: flex;padding-top:23px;">
                                                                        @can('orders.activetion')
                                                                        <div class="badge badge-pill badge-light-danger mr-50" href="#myModal{{$product->id}}" role="button" data-toggle="modal">
                                                                            {{__('common.delete')}}
                                                                        </div>
                                                                        <div class="badge badge-pill badge-light-secondary mr-50" href="#cancel_product{{$product->id}}" role="button" data-toggle="modal">
                                                                        ...
                                                                        <a href ="{{url(app()->getLocale().'/products/'.$product->id.'/edit')}}">
                                                                ...
                                                                <!--Form cancel product -->
                                                                <div id="cancel_product{{$product->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button> -->
                                                                            ...
                                                                            <form id="FormCancelProduct" action="javascript:void(0)">
                                                                                @csrf
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button class="btn default" data-dismiss="modal" aria-hidden="true">{{__('common.cancel')}}</button>
                                                                                    <button class="btn btn-secondary" id="cancel_product_btn">{{__('common.cancel_product')}}</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody id="menu">
                                                                ...
                                                                <tr id="tr-{{$product->id}}">
                                                                    <td>
                                                                        <form id="ListProductsForm" action="javascript:void(0)">
                                                                            @csrf
                                                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                                                <input  name="chkBox[]" value="{{$product->id}}" onclick="check_all()" type="checkbox" class="checkboxes chkBox"  />
                                                                                <span></span>
                                                                            </label>
                                                                            <input id="my-hidden-field" name="array" type="hidden"/>
                                                                        </form>
                                                                    </td>
                                                                    <td>
                                                                        <span class="font-weight-bold">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <span class="badge badge-pill badge-light-info mr-1">{{ $product->activators->name }}</span>
                                                                        @else
                                                                        <span class="badge badge-pill badge-light-info mr-1">{{ __('common.not_active') }}</span>
                                                                        @endif
                                                                    </td>
                                                                    @endcan
                                                                    @can('products.activetion')
                                                                    ...
                                                                    <td style="display: flex;padding-top:23px;">
                                                                        ...
                                                                        @if((($product->price - $product->price_offer) / $product->price) > $product->products_category->categories->min_promotion)
                                                                        <a>
                                                                            <div class="badge badge-pill badge-light-info mr-50">
                                                                                @if($product->promotion == 1)
                                                                                <span id="promotion{{$product->id}}">{{__('common.send_order')}}</span>
                                                                                @else
                                                                                <span onclick="make_promotion_product({{$product->id}})" id="promotion{{$product->id}}">{{__('common.promotion')}}</span>
                                                                                @endif
                                                                            </div>
                                                                        </a>
                                                                        @endif
                                                                        @if(count($stores) > 0)
                                                                            @if($product->store == 0)
                                                                            <div id="store_{{$product->id}}" class="badge badge-pill badge-light-info mr-50" style="cursor: pointer;" data-toggle="modal" data-target="#move_to_store{{$product->id}}">
                                                                                {{__('common.move_to_store')}}
                                                                            </div>
                                                                            @else
                                                                            <div class="badge badge-pill badge-light-info mr-50" style="cursor: pointer;">
                                                                ...
                                                                <!-- End Form Delete -->
                                                                <!--Move Store-->
                                                                <div id="move_to_store{{$product->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                                                    <div class="modal-dialog" style="max-width: 820px;">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form id="FormMoveProduct" action="javascript:void(0)">
                                                                                    @csrf
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <div class="row">
                                                                                                <div class="col-lg-6">
                                                                                                    <div>
                                                                                                        <img src="{{$product->image}}" width="100%" height="270px" alt="" />
                                                                                                        <h6 style="margin-top: 16px;font-weight: bold;font-size: 20px;">
                                                                                                            {{$product->name_ar}}
                                                                                                        </h6>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-lg-6">
                                                                                                    <div style="margin-bottom: 20px;">
                                                                                                        ...
                                                                                                        <select class="form-control" name="store_id" onchange="get_branches(this)">
                                                                                                    ...
                                                                                                    <div style="margin-bottom: 20px;">
                                                                                                        ...
                                                                                                        <select class="form-control" name="branche_id" id="branches">
                                                                                                            <option disabled selected>{{__('common.branche')}}</option>
                                                                                                        </select>
                                                                                                    </div>
                                                                                                    <div style="margin-bottom: 20px;">
                                                                                                        <label for="t-text" class="">{{__('common.Qty')}}</label>
                                                                                                        <input id="t-text" type="number" name="product_qty" placeholder="{{__('common.Qty')}}" class="form-control" required>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div style="margin-bottom: 20px;">
                                                                                                <label for="t-text" class="">{{__('common.notes')}}</label>
                                                                                                <textarea id="t-text" type="text" rows="4" name="vendor_notes" placeholder="{{__('common.notes')}}" class="form-control"></textarea>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="modal-footer md-button">
                                                                                        <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i>{{__('common.cancel')}}</button>
                                                                                        <button id="btn_move_to_store" class="btn btn-primary">{{__('common.save')}}</button>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <tbody id="menu_canceled">
                                                                ...
                                                                <tr id="tr_cancel-{{$product->id}}">
                                                                    ...
                                                                    <td style="display: flex;padding-top:23px;">
                                                                        ...
                                                                        <div class="badge badge-pill badge-light-success mr-50" href="#return_product{{$product->id}}" role="button" data-toggle="modal">
                                                                ...
                                                                <!--Form return_product -->
                                                                <div id="return_product{{$product->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button> -->
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <button class="btn default" data-dismiss="modal" aria-hidden="true">{{__('common.cancel')}}</button>
                                                                                <button class="btn btn-success" onclick="return_product({{$product->id}})">{{__('common.return_product')}}</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<div class="modal fade text-left" id="xlarge" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url(app()->getLocale().'/products')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6 mx-auto"> 
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.duration_received_'.$locale->lang)}}</label>
                                <input id="t-text" type="text" name="duration_received_{{$locale->lang}}" placeholder="{{__('common.duration_received_'.$locale->lang)}}" class="form-control" required>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.description_'.$locale->lang)}}</label>
                                <textarea id="t-text" type="text" name="description_{{$locale->lang}}" placeholder="{{__('common.description_'.$locale->lang)}}" class="form-control" required></textarea>
                            </div> 
                        </div>
                        @endforeach
                        ...
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                ...
                                <input id="t-text" type="text" name="code" placeholder="{{__('common.code')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.Qty')}}</label>
                                <input id="t-text" type="number" name="qty" placeholder="{{__('common.Qty')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.price')}}</label>
                                <input id="t-text" type="number" name="price" placeholder="{{__('common.price')}}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.price_offer')}}</label>
                                <input id="t-text" type="number" name="price_offer" placeholder="{{__('common.price_offer')}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.start_date')}}</label>
                                <input id="t-text" type="date" name="start_date" placeholder="{{__('common.start_date')}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                <label for="t-text" class="">{{__('common.end_date')}}</label>
                                <input id="t-text" type="date" name="end_date" placeholder="{{__('common.end_date')}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-4 col-4 mx-auto">
                            <div style="margin-bottom: 20px;">
                        ...
                        <div class="col-lg-6 col-6 mx-auto">
                            <div style="margin-bottom: 20px;">
                                ...
                                <input id="t-text" type="number" name="points" placeholder="{{__('common.points')}}" class="form-control" required>
                            </div>
                        </div>
...
<!--category-->
<div class="modal fade text-left" id="products_list_fadeupModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
    ...
    <div class="modal-dialog" style="max-width:65%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{url(app()->getLocale().'/move_products_store')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                    {{ csrf_field() }}
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div style="margin-bottom: 20px;">
                                        <label for="t-text" class="">{{__('common.store')}}</label>
                                        <select class="form-control" name="store_id" onchange="get_branches_products(this)">
                                            <option disabled selected>{{__('common.store')}}</option>
                                            @foreach($stores as $store)
                                            <option value="{{$store->store_id}}">
                                                {{$store->stores->company_name}}
