                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ url('/products') }}">{{ __('common.products') }}</a>
                                    </li>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-12 col-md-7">
                                    ...
                                    <div class="d-flex flex-column flex-sm-row pt-1">
                                        <form id="FormCreateProduct" action="{{ route('store_product') }}" method="post"
                                            style="width:100%;">
                                            @csrf
                                                ...
                                                <div class="col-lg-6 col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="code"
                                                            placeholder="{{ __('common.code') }}" name="code"
                                                            required />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-xs-6">
                                                    <button class="btn btn-primary btn-cart mr-0 mr-sm-1 mb-1 mb-sm-0"
                                                        type="submit" style="margin-top: 23px;" id="create_product_btn">
