                                    ...
                                    <div class="col-xl-6 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
                                        <div class="user-avatar-section">
                                            <div class="d-flex justify-content-start">
                                                @if($client->photo)
                                                <img class="img-fluid rounded" src="{{$client->photo}}" height="104" width="104" alt="User avatar" />
                                                @endif
                                                <div class="d-flex flex-column ml-1">
                                                    ...
                                                    <div class="d-flex flex-wrap">
                                                        <a href="{{url(app()->getLocale().'/clients/'.$client->id.'/edit')}}" class="btn btn-primary">{{__('common.edit')}}</a>
                                                        <a href="#myModal{{$client->id}}" role="button" data-toggle="modal">
                                    ...
                                    <ul class="nav nav-tabs nav-left flex-column" role="tablist">
                                        ...
                                        <li class="nav-item" style="display:flex;margin-bottom:25px;">
                                            <div class="avatar mr-50">
                                                <img src="{{$contact->vendors->data->ID_image}}" alt="Avatar" width="38" height="38" />
                                            </div>
                                            <a class="nav-link {{ $loop->first ?  'active' : '' }}" id="baseVerticalLeft-tab1" data-toggle="tab" aria-controls="tabVerticalLeft1" href="#tabVerticalLeft{{$contact->id}}" role="tab" aria-selected="true">{{$contact->vendors->name}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                    <div class="tab-content">
                                        @foreach($contacts as $contact)
                                        <div class="tab-pane {{ $loop->first ?  'active' : '' }}" style="overflow-y: scroll;height:500px;" id="tabVerticalLeft{{$contact->id}}" role="tabpanel" aria-labelledby="baseVerticalLeft-tab1">
                    ...
                    <!-- Vertical Left Tabs ends -->
                        ...
                        <div class="col-lg-6 col-6">
                            <div class="card card-user-timeline">
                                ...
                                <div class="card-body"> 
                                    <ul class="timeline ml-50" id="admin_messages" style="overflow-y: scroll;height:500px;">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 col-12 mb-1">
                                                                    <div class="input-group">
                                                                        <input type="hidden" value="{{$contact_admin->id}}" name="contact_id" />
                                                                        ...
                                                                        <div class="input-group-append" id="button-addon2">
                                                                            <button class="btn btn-outline-primary" id="admin_message_btn" type="button">{{__('common.send')}}</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.message === 'Success') {
                        ...
                        $('#admin_messages').append('<span class="timeline-point timeline-point-warning timeline-point-indicator"></span>'+
                                                '<div class="timeline-event">'+
                                                    '<div class="media align-items-center">'+
                                                        '<div class="avatar mr-50">'+
                                                            '<img src="' + response.image + '" alt="Avatar" width="38" height="38" />'+
