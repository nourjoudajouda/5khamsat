            ...
            <div class="content-header-right text-md-right col-md-5 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        ...
                        <button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" data-toggle="modal" data-target="#client_fadeupModal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('common.add_new_client')}}</button>
                    </div>
                </div>
            </div>
            @endcan
                            ...
                            <table class="table">
                                ...
                                <tbody id="menu">
                                    ...
                                    <tr id="tr-{{$client->id}}">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between" id="switch_activate" style="margin-bottom: 10px;">
                                                <div class="custom-control custom-switch"> 
                                                    <input type="checkbox" id="paymentTerms{{$client->id}}" class="custom-control-input toggle-class{{$client->id}}" data-id="{{$client->id}}" onclick="change_status({{$client->id}})" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $client->status ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="paymentTerms{{$client->id}}"></label> 
                                                </div>
                                            </div>
                                        </td>
                                        @endcan
                                        <td>
                                            @can('clients.operations')
                                            <div class="badge badge-pill badge-light-danger mr-50" href="#myModal{{$client->id}}" role="button" data-toggle="modal">
                                                {{__('common.delete')}}
                                            </div>
                                            ...
                                            @can('clients.operations')
                                            <div class="badge badge-pill" data-toggle="modal" data-target="#message_fadeupModal{{$client->id}}">
                                                <img src="{{url('public/dashborad/app-assets/images/mail.svg')}}" style="cursor: pointer;" alt />
                                            </div>
                                            <div class="badge badge-pill" data-toggle="modal" data-target="#mobile_fadeupModal{{$client->id}}">
                                    ...
                                    <!--Message-->
                                    <div id="message_fadeupModal{{$client->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                    ...
                                    <!--Mobile-->
                                    <div id="mobile_fadeupModal{{$client->id}}" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
                                        <div class="modal-dialog">
                                            <!-- Modal content-->
                                            <div class="modal-content">
                                                <div class="modal-header">
                                    ...
                                    <!--Form Delete -->
                                    <div id="myModal{{$client->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button class="btn btn-danger" onclick="delete_adv({{$client->id}})">{{__('common.delete')}}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div id="client_fadeupModal" class="modal animated fadeInUp custo-fadeInUp" role="dialog">
    <div class="modal-dialog" style="max-width:65%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{url(app()->getLocale().'/clients')}}" enctype="multipart/form-data" class="form-horizontal" role="form" style="padding-top: 20px;">
                    {{ csrf_field() }}
                    <div class="row">
