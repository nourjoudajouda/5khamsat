...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/site/assets/images/logo.png')}}">
    @yield('style_sheet')

    <link rel="stylesheet" href="{{asset('public/site/assets/css/all.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('public/site/assets/css/owl.theme.default.css')}}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" href="{{asset('public/site/assets/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('public/site/assets/css/media.css')}}">
    @endif
...
<body>
    <div class="mobile-menu">
	    <div class="menu-mobile">
	        <div class="mmenu">
		        <ul>
					<li>
						<a href="index.html"><img src="{{asset('public/site/assets/images/logo.png')}}" class="" alt=""/></a>
					</li>
					<li>
						<a href="#">Shop</a>
					</li>
                ...
                <div class="icon_mobile">
                    ...
                    <a class="" href=""><i class="fa-solid fa-cart-shopping"></i><span class="badge badge-notify my-cart-badge"></span></a>
                </div>
			</div>
		</div>
                ...
                <div class="box d-flex col-lg-4 col-md-6 col-sm-12 top_nav">
                    ...
                    <div class="dropdown me-3">
                        <a class=" dropdown-toggle text-white" href="#" role="button" id="dropdownMenuLink"
                            ...
                            AR
                            @endif
                            <i class="ms-1 fa-solid fa-angle-down"></i></a>
                        <ul class="dropdown-menu bg-black p-0" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}">AR</a></li>
                            <li><a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">En</a></li>
                        </ul>
                    </div>
            ...
            <div class="row ">
                <div class=" logo-search col-lg-6 col-md-12 ">
                    <div class="logo col-lg-2">
                        <img src="{{asset('public/site/assets/images/logo.png')}}" alt="">
                    </div>
                ...
                <div class=" box col-lg-6 col-md-12">
                    ...
                    <div class="icon ">
                        ...
                        <a class="" href=""><i class="fa-solid fa-cart-shopping d_media"></i><span class="badge badge-notify my-cart-badge d_media"></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class=" pt-5 mt-5">
        <div class="container">
            <div class="row row_footer">
                <div class="col-xs-12 col-lg-2  col-md-5  logo">
                    <img class="d-block mb-3 text-muted logo_footer" src="{{asset('public/site/assets/images/logo1.png')}}" alt="">
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-xs-12 follow">
                    <h5>Follow Us</h5>
                    <ul class="list-unstyled text-small">
                        <li><a class="" href="#"><i class="fa-brands fa-facebook-f"></i> <p>Facebook</p> </a></li>
                        <li><a class="" href="#"><i class="fa-brands fa-youtube"></i> <p>Youtube</p></a></li>
                        <li><a class="" href="#"><i class="fa-brands fa-instagram"></i><p>Instagram</p></a></li>
                        <li><a class="" href="#"><i class="fa-brands fa-linkedin-in"></i><p>Linkedin</p></a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="box pt-4 pb-4">
            <div class="shop">
                <a href=""><img src="{{asset('public/site/assets/images/app-store 1.png')}}" alt=""></a>
                <a href=""><img src="{{asset('public/site/assets/images/google-play 1.png')}}" alt=""></a>
            </div>
            <div class="payment">
                <a href=""><img src="{{asset('public/site/assets/images/ApplePay.jpg')}}" alt=""></a>
                <a href=""><img src="{{asset('public/site/assets/images/Paypal.jpg')}}" alt=""></a>
                <a href=""><img src="{{asset('public/site/assets/images/Mastercard.jpg')}}" alt=""></a>
                <a href=""><img src="{{asset('public/site/assets/images/Stripe.jpg')}}" alt=""></a>
            </div>
        </div>
    ...
    <script src="{{asset('public/site/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('public/site/assets/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('public/site/assets/js/jquery.mycart.js')}}"></script>
    <script src="{{asset('public/site/assets/js/all.min.js')}}"></script>
    <script src="{{asset('public/site/assets/js/5KHAMSAT.js')}}"></script>
    <script>
        $('.sub-menu ul').hide();
